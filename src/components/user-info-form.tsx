...
export const UserInfoForm: React.FC = () => {
  ...
  return (
    // Removed Card wrapper as it's now handled by AssessmentWizard
    <Form {...form}>
      <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
        {/* Removed CardHeader as it's in AssessmentWizard */}
        <CardContent className="space-y-4 p-0"> {/* Removed padding from CardContent */}
        ...
        <CardFooter className="flex justify-end p-0"> {/* Removed padding */}
          <Button type="submit">
